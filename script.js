...
let Clock = () => {
	...
	React.useEffect(() => {
		let canvas = new fabric.Canvas('clock', options)
	...
	return <canvas class='cvs' id='clock'></canvas>
}

let App = () => {
	return (
		<div>
			<div className='heads' id='tabs'>
				<ul>
					<li className='tab' data-attr='clock'>
						clock
					</li>
					<li className='tab active' data-attr='tic'>
						tic tac teo
					</li>
				</ul>
			</div>
